...
\begin{figure}[htbp]
  ...
  \caption{PermitKey overview. Heterogeneous local permitting portals connect to a shared multi-label work-type vocabulary while source provenance and missingness remain traceable.}
...
\begin{figure}[htbp]
  ...
  \caption{National distribution of building-permit records. Records with valid U.S. coordinates are aggregated to grid cells and displayed on a logarithmic color scale. Alaska, Hawaii, and Puerto Rico are shown as insets. The map shows the observed distribution of records across populated cells.}
