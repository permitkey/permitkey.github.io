...
\section{Limitations}
Coverage and field quality vary across jurisdictions and years. Source records are occurrences rather than deduplicated unique permits, and multi-label counts are not additive. Weak supervision inherits errors and omissions from local labels; human-review estimates and source-rights checks are included in the release record. Aggregate geography and disclosure rules are applied to every public table, with eligible coverage and uncertainty documented alongside it.
